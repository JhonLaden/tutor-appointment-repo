    ...
    <br>
        ...
        <div class="container ">
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-1">How can payments be made? Can I pay monthly? <i class='bx bx-chevron-down icon'></i></label> 
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-2">How do you take payments? <i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Cost</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-3">Is there a sibling discount available?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Cost</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-4">Do I need to pay deposit if I pay the annual fee in full?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Cost</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-5">Do you offer online tutoring?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-6">Is our tutoring one-to-one or with a group?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-7">What subjects do you offer tutoring in?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-8">Are you flexible with tutoring days and times?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-9">As a student, what can I expect from my tutoring sessions?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
            ...
            <div class="collapsible">
                ...
                <label for="collapsible-head-10">How are sessions tailored to the needs of each student?<i class='bx bx-chevron-down icon'></i></label> 
                <div class="collapsible-text">
                    <h2>Tutoring</h2>
